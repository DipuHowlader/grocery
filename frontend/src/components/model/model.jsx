...
function Model() {
    return (
        <>
            <div id="small-dialog1" className="mfp-hide d-none">
	...
	<div className="modal fade d-none" id="myModal1" tabIndex="-1" role="dialog">
	...
	<div className="modal fade  d-none" id="myModal2" tabIndex="-1" role="dialog">
		<div className="modal-dialog">
			 {/* Modal content--> */}
			<div className="modal-content">
				<div className="modal-header">
